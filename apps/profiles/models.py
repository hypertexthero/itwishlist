...
class Profile(ProfileBase):
    name = models.CharField(_("Name"), max_length=50, null=True, blank=True, help_text="Your it.ippc.int byline (best to use your real name unless you want to confuse people :)")
